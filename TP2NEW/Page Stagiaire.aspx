...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GestionStagesConnectionString %>" SelectCommand="SELECT [Id], [Titre], [Début], [Fin], [Commentaire] FROM [Stage]"></asp:SqlDataSource>
    </form>
</body>
</html>
