    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Label ID="Label3" runat="server" Font-Size="Larger" Text="Stages"></asp:Label>
                ...
                <asp:GridView ID="gvStages" runat="server" AutoGenerateColumns="False" DataSourceID="dsStages" OnSelectedIndexChanged="gvStages_SelectedIndexChanged">
                    <Columns>
